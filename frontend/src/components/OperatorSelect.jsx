                ...
                <div className="space-y-3 mb-6">
                  <div>
                    ...
                    <div className="h-1.5 bg-white/10">
                      <div className="h-full bg-[#39FF14]" style={{ width: `${displayOp.stats.health / 1.3}%` }} />
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between text-xs font-mono text-[#8B93A6] mb-1">
                    ...
                    <div className="h-1.5 bg-white/10">
                      <div className="h-full bg-[#00E5FF]" style={{ width: `${displayOp.stats.armor}%` }} />
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between text-xs font-mono text-[#8B93A6] mb-1">
                    ...
                    <div className="h-1.5 bg-white/10">
                      <div className="h-full bg-[#FFB800]" style={{ width: `${displayOp.stats.speed * 80}%` }} />
                    </div>
                  </div>
                </div>
